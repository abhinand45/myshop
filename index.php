...
<head>
    ...
    <!-- Font Awesome CDN for profile icon -->
    ...
    <section class=" top-txt ">
        <div class="head container ">
            ...
            <div class="sing_in_up ">
                <a href="./authendication/register/register.php">SIGN IN</a>
                <a href="./authendication/login/login.php">SIGN UP</a>
                <!-- <a class="fas fa-user" href="profile.php"></a> -->
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="menu-items">
                ...
                <li>
                <li>
                    <a href="./cart/cart.php" class="fas fa-shopping-cart">
                        <span class="cart-count">(<?= $_SESSION['cart_count'] ?? 0; ?>)</span>
                    </a>
                </li>

                <!-- <a href="./cart/cart.php" class="fas fa-shopping-cart"></a> -->
                </li>
                <li>
                    <div class="profile-dropdown">
                        <i class="fas fa-user"></i>
                        <div class="dropdown-content">
                            <a href="./authendication/profile/user.php">View Profile</a>
        ...
        <div class="collections container">
            <div class="content">
                ...
                <div class="img-content">
                    ...
                    <button><a href="http://localhost/myshop/categories/shoes.php?category=Cloths">SHOP NOW</a></button>
                </div>
            </div>
            <div class="content2">
                ...
                <div class="img-content2">
                    <p>Shoes Spring</p>
                    <button><a href="http://localhost/myshop/categories/shoes.php?category=Shoes">SHOP NOW</a></button>
                </div>
            </div>
            <div class="content3">
                ...
                <div class="img-content3">
                    <p>Accessories</p>
                    <button><a href="http://localhost/myshop/categories/shoes.php?category=Accessories">SHOP NOW</a></button>
                </div>
            </div>
        </div>
    </section>
